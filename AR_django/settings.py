"""
Django settings for AR_django project.
...
ALLOWED_HOSTS = ["backenddjango-production.up.railway.app", "https://backenddjango-production.up.railway.app" ]
...
WSGI_APPLICATION = 'AR_django.wsgi.application'
